...
#
# Generated on Fri Oct 10 16:30:39 GMT 2025
...
#
 $WGET  --secure-protocol=auto --save-cookies="$COOKIE_FILE" --keep-session-cookies --http-user "$SSO_USERNAME" --ask-password  "" -a "$LOGFILE"
...
then
 ...
 $WGET --load-cookies="$COOKIE_FILE" "" -O "$OUTPUT_DIR/V982063-01.zip" >> "$LOGFILE" 2>&1
fi
